...
CATEGORY_PROFILES: dict[int, dict[str, object]] = {
    126: {
        ...
        "profile": [
            ...
            "每条商品都应明确落到苏州语境，不能写成泛江苏或全国通货。",
            "标题尽量体现苏州/姑苏/阳澄湖/洞庭山等地域特征、核心品类、特色或送礼场景，且一眼能看出是食品或伴手礼。",
            "如不确定具体地标、老字号或地理标志信息，必须采用保守表述，不得虚构认证或历史背书。",
            "attrs 至少包含 产地城市、规格、包装形式、适用场景，其中 产地城市 必须写为苏州。",
            "禁止输出工艺摆件、茶具香器、服务商品或与苏州特产无关的全国通货。",
        ],
    },
    127: {
        "name": "农副产品",
